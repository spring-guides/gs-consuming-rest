...
We have provided an example of such a service at https://github.com/spring-guides/quoters/api,
(which shows all the quotations).
...
Other valid addresses http://localhost:8080/api/1 (for the first quotation), http://localhost:8080/api/2
(for the second quotation), and so on.
