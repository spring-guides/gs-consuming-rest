...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/consumingrest/Quote.kt[]
----

The domain class is annotated with `@JsonIgnoreProperties` from the Jackson JSON
...
You also need an additional domain class to embed the inner quotation itself. The `Value` class fills that need,
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/consumingrest/Value.kt[]
----
====
...
.Kotlin
----
include::initial-kotlin/src/main/kotlin/com/example/consumingrest/ConsumingRestApplication.kt[]
----
====
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/consumingrest/ConsumingRestApplication.kt[]
----
====
