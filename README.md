...
Below is the [initial Gradle build file](https://github.com/spring-guides/gs-consuming-rest/blob/master/initial/build.gradle). But you can also use Maven. The pom.xml file is included [right here](https://github.com/spring-guides/gs-consuming-rest/blob/master/initial/pom.xml). If you are using [Spring Tool Suite (STS)][gs-sts], you can import the guide directly.
...
Below are the Gradle steps, but if you are using Maven, you can find the updated pom.xml [right here](https://github.com/spring-guides/gs-consuming-rest/blob/master/complete/pom.xml) and build it by typing `mvn clean package`.
...
```
You can see the final version of `build.gradle` [right here]((https://github.com/spring-guides/gs-consuming-rest/blob/master/complete/build.gradle).
...
> **Note:** If you are using Maven, you can run your service by typing `mvn clean package && java -jar target/gs-consuming-rest-0.1.0.jar`.
